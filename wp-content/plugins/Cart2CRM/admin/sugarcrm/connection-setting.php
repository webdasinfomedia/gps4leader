...
?>
<h1><?php _e('Sugar CRM Setting','cart2crm');?></h1>
<div class="crm-settings-panel pick">
<p><?php _e('This plugin allows you to integrate your existing SugarCRM to your Woocommerce data.','cart2crm');?></p>
	<div class="custom-crmform">
		<div class="metabox-prefs">
			<form method="post" action="">
				...
				<i><?php _e('e.g. "http://www.mobilewebs.net/sugarcrm/" (don\'t forget the "/" at the end) ','cart2crm');?></i>
				</p>
				<p>
			    ...
			    <?php _e('( the order will automatically be synced to SugarCRM. ) ','cart2crm');?> 
			    </p>
			    <br />
			    <input type="hidden" name="crm_name" value="sugarcrm">
