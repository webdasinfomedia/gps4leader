...
$soapclient = new nusoap_client($suitecrm_options['crm_url'].'soap.php?wsdl',true);
$user_auth = array(
		'user_auth' => array(
				'user_name' => $suitecrm_options['user_name'],
				'password' => md5($suitecrm_options['password']),
				'version' => '0.1'
		),
...
<h2 class="nav-tab-wrapper">  
	<a class="nav-tab nav-tab-active" href="#"><?php _e('Suite CRM Report','cart2crm')?></a>    
</h2>
<?php 

if($suitecrm_conection['error']['number'] == 0)
{
?>
...
if(isset($_REQUEST['cust_report']))
{
	...
	$wp_user_search=$db->getCustomerReport($status,$fromdate,$todate,3);
